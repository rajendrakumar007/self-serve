        ...
        <div className="grid grid-cols-1 md:grid-cols-12 md:items-end gap-2">
          ...
          <div className="md:col-span-3">
            ...
            <select
              ...
              className="w-full rounded-md border border-borderDefault bg-bgBase text-textPrimary px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 dark:bg-gray-800 dark:text-white dark:border-gray-600"
            >
