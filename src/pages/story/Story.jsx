...
import Navbar from "../../components/common/Navbar"; // <-- fixed path

const StoryPage = () => {
  return (
    <>
      <Navbar />
<main className="max-w-4xl mx-auto p-6 bg-bgBase dark:bg-secondary">
  <section className="mb-8">
    <h1 className="text-4xl font-bold mb-4 text-primary dark:text-textInverted">
      How Insurance Changed Everything For The Mehta Family
    </h1>
    <article className="space-y-6 leading-relaxed text-textPrimary dark:text-textInverted">
      <p>
  ...
  <article className="space-y-6 text-textPrimary dark:text-textInverted leading-relaxed">
    <p>
    ...
    <p>
      Thanks to their <strong className="text-primary dark:text-primaryLight">SELFSERVE Health Policy</strong>, the
    ...
    <blockquote className="bg-primary/10 dark:bg-primary/20 border-l-4 border-primary p-4 italic text-lg text-textPrimary dark:text-textInverted">
