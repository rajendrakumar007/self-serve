...
const PolicyCard = ({ p }) => {
    ...
    const selectedOption =
        selectedIdx >= 0 ? tenureOptions[selectedIdx] : null;
    ...
    const handleBuy = () => {
        // Pass selected tenure info along with policy
         ...
         const payload = {
                ...p,
                selectedTenure:
                    selectedOption?.tenure ?? 1,
                selectedPremiumTotal:
                    selectedOption?.total ?? p.premium,
            };
    ...
    return (
        <>
            <div className="bg-bgCard rounded-lg p-5 shadow-sm flex flex-col justify-between hover:shadow-lg transition-shadow duration-200">
                <div>
                    {/* Title & Policy ID */}
                    ...
                    <div className="mb-3">
                        <div className="text-xs uppercase tracking-wide text-textSecondary mb-1">
                            Coverage
                        </div>
                    ...
                    {/* Terms / Description */}
                    {p.terms ? (
                        <div className="text-textSecondary text-sm mb-4 italic">
                            {p.terms}
                        </div>
                    ) : null}
                    ...
                    {tenureOptions.length > 0 ? (
                        <div className="mb-2">
                            <div className="text-xs uppercase tracking-wide text-textSecondary mb-2">
                                Premium by Tenure
                            </div>
